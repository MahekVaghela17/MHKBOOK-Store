  ...
  <section class="inspired_product_area section_gap_bottom_custom">
    <div class="container">
      ...
      <?php
        ...
        $inspired = [];
        // Use random selection for variety; fallback to latest if RAND() not preferred
        $qry = "SELECT id, productname, productprice, image FROM products ORDER BY RAND() LIMIT 8";
      ...
      <div class="row">
        <?php if (!empty($inspired)): ?>
          <?php foreach ($inspired as $p): ?>
